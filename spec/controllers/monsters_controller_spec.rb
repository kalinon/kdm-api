...
RSpec.describe MonstersController, type: :controller do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      ...
      it 'renders a JSON response with the new monster' do
        post :create, params: { monster: valid_attributes }, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(monster_url(Monster.last))
      end
    end

    context 'with invalid params' do
      it 'renders a JSON response with errors for the new monster' do
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested monster' do
        ...
        monster.reload
        expect(monster.name).to eq 'new-name'
      end

      it 'renders a JSON response with the monster' do
        monster = Monster.create! valid_attributes
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the monster' do
        monster = Monster.create! valid_attributes
